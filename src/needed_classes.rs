...
#[derive(Default)]
pub struct CInst {
    pub ns_entry_num: u8, //This entry num in opcode hash entry
    pub opcode_cnt: u8,
    pub opcode: Vec<u8>,
    pub flags: u16,
    pub slash_val: u8,
    pub uasm_slash_val: u8,
    pub opcode_modifier: u8,
    pub arg1: u8,
    pub arg2: u8,
    pub size1: u8,
    pub size2: u8, //Size in bits
    pub pad: u8,
}

pub struct CHashOpcode<'a> {
    pub parent: CHash<'a>,
    pub inst_entry_cnt: u16,
    pub oc_flags: u16,
    pub pad: Vec<u16>,
    pub ins: Vec<CInst>,
}
...
#[derive(Default)]
pub struct CAsmIns<'a> {
    pub tmpins: Option<&'a mut CInst>,
    pub imm: CAsmNum2<'a>,
    pub disp: CAsmNum2<'a>,
    pub U8_cnt: i64,
    pub last_opcode_U8: i64,
    pub REX: i64,
    pub ModrM: i64,
    pub SIB: i64,
    pub has_REX: bool,
    pub has_ModrM: bool,
    pub has_SIB: bool,
    pub has_addr_prefix: bool,
    pub has_operand_prefix: bool,
    pub is_dft: bool,
    pub pad: Vec<bool>,
}
